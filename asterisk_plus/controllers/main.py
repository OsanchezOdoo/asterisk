...
class AsteriskPlusController(http.Controller):
    ...
    def get_caller_name(self, **kw):
        ...
        try:
            ...
            logger.info('Caller name request for number {} country {}'.format(
                number, country_code))
    ...
    @http.route('/asterisk_plus/initialize', auth='none', type='json')
    def initialize(self, **kw):
        ...
        try:
            ...
            logger.info('Cannot set server timezone to %s: %s', tz, e)
